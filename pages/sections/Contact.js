...
const Contact = () => {
  return (
    <section className="contact lg:mt-0 mt-96">
        ...
        <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div className="mt-8 overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2">
                    <div className="p-6 mr-2 sm:rounded-lg" style={bg}>
                        <h1 className="text-4xl sm:text-5xl text-yellow-200 dark:text-white font-extrabold tracking-tight">
                            Get in touch
                        </h1>
                        ...
                        <div className="flex items-center mt-8 text-white dark:text-gray-400">
                            {/* <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" className="w-8 h-8 white">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                            </svg> */}
                            <div className="ml-4 text-md tracking-wide font-semibold w-40">
                            Greenest buildings and business pvt ltd,
Tc14/733, Nandavanam, Thiruvananthapuram
                            </div>
                        </div>
                    ...
                    <form className="p-6 flex flex-col justify-center">
                        ...
                        <button type="submit" className="md:w-32 bg-purple-400 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-indigo-500 transition ease-in-out duration-300" style={bg}>
                            Submit
                        </button>
                    </form>
                </div>
